...
# time.sleep(0.3)
res = arm.move_math(0, 0)
print("\n".join(res.reply))
time.sleep(0.3)


print("Nudge +40 mm in X, keep Y/Z unchanged...")
res3 = arm.move_delta_xyz(dy=-60)     # dy/dz default to None → unchanged
print("\n".join(res3.reply))

time.sleep(0.3)

print("Nudge +40 mm in X, keep Y/Z unchanged...")
res3 = arm.move_delta_xyz(dy=120)     # dy/dz default to None → unchanged
print("\n".join(res3.reply))
...
# res4 = arm.move_delta_xyz(dx=-100)
# print("\n".join(res4.reply))
